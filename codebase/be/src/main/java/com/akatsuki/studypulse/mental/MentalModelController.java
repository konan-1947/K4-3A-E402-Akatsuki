...
public class MentalModelController {
    ...
    public ResponseEntity<?> approve(@PathVariable String runId, @RequestBody JsonNode mentalModel) throws IOException {
        return ResponseEntity.ok(jobs.approve(runId, mentalModel));
    }
}
