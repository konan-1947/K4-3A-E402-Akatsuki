...
export default function LabCoachPage() {
  ...
  const selectFiles = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    demo.setUploads((current) => [...current, ...picked]);
    event.target.value = "";
  };
  const continueToMentalModel = () => router.push("/labcoach/mental");
